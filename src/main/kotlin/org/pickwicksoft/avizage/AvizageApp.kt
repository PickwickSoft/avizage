...
import org.pickwicksoft.avizage.config.ApplicationProperties
import org.pickwicksoft.avizage.config.CRLFLogConverter
...
class AvizageApp(private val env: Environment) {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<AvizageApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(AvizageApp::class.java)
