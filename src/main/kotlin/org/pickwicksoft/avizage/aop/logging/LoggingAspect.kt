package org.pickwicksoft.avizage.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(org.pickwicksoft.avizage.repository..*)" +
            " || within(org.pickwicksoft.avizage.service..*)" +
            " || within(org.pickwicksoft.avizage.web.rest..*)"
    )
